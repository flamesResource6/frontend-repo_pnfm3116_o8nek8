...
export function Collections() {
  const items = [
    { title: 'Everyday Second Skin', desc: 'Breathable comfort for all-day ease.' },
    { title: 'Sculpt & Support', desc: 'Smooth control with zero compromise.' },
    { title: 'Luxe Lace', desc: 'Delicate, resilient, timeless.' },
  ]
  return (
    <section id="collections" className="bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex items-end justify-between gap-6">
          <div>
            <h2 className="font-serif text-3xl sm:text-4xl text-neutral-900">Collections</h2>
            <p className="mt-3 text-neutral-700 max-w-xl">Editorial pieces designed for comfort and confidence.</p>
          </div>
          <a href="#" className="hidden sm:inline-flex items-center rounded-full border border-neutral-900 px-5 py-2 text-sm hover:bg-neutral-900 hover:text-white">Shop all</a>
        </div>
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {items.map((c) => (
            <div key={c.title} className="group relative overflow-hidden rounded-3xl border border-neutral-200 aspect-[4/5] bg-[linear-gradient(145deg,#EFE7E2,transparent)]">
              <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?q=80&w=1600&auto=format&fit=crop')] bg-cover bg-center opacity-20 group-hover:scale-105 transition-transform" />
  ...
  return (
    <section className="bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <h2 className="font-serif text-3xl sm:text-4xl text-neutral-900">Designed for Every Body</h2>
  ...
  return (
    <section className="bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid md:grid-cols-2 gap-12 items-center">
        <div>
          <h2 className="font-serif text-3xl sm:text-4xl text-neutral-900">Intelligence that respects intimacy</h2>
        ...
        <div className="rounded-3xl border border-neutral-200 aspect-[4/3] bg-[radial-gradient(circle_at_center,#F7EDEE,transparent_60%)]" />
      </div>
    </section>
  )
}
...
export function Join() {
  return (
    <section id="join" className="bg-[#F7EDEE]">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <h2 className="font-serif text-3xl sm:text-4xl text-neutral-900">Join NERA</h2>
        <p className="mt-3 text-neutral-700">Early access, fit tips, and private drops. Gentle updates only.</p>
        <form onSubmit={(e)=>e.preventDefault()} className="mt-8 flex flex-col sm:flex-row items-center gap-3">
          <input type="email" required placeholder="you@example.com" className="w-full sm:flex-1 rounded-full border border-neutral-300 bg-white px-4 py-3 text-neutral-900 placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-[#BDAE96]" />
          <button className="inline-flex items-center rounded-full bg-neutral-900 text-white px-6 py-3 text-sm font-medium hover:bg-[#2B1636] focus:outline-none focus:ring-2 focus:ring-[#BDAE96] focus:ring-offset-2 focus:ring-offset-[#F7EDEE]">Join</button>
        </form>
